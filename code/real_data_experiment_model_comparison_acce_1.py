...
if __name__ == "__main__":
    ...
    parser.add_argument('--config', type=str, default="ms_deterministic_infonce_alt")
    ...
    if args.config == 'm1_stochastic_infonce':
        ...
        ydims = np.array([5]).astype(int)
    elif args.config == 'm1_deterministic_infonc e_alt':
        ...
        ydims = np.array([5]).astype(int)
    elif args.config == 'ms_stochastic_infornce_alt':
    ...
    if args.config == "temp_stochastic_infonce" or args.config == "temp_stochastic_infonce_alt"\
        ...
        X, Y = weather, weather
        good_ts = None
    if args.config == "ms_stochatic_infonce" or args.config == "ms_stochastic_infornce_alt" or args.config == "ms_deterministic_infonce_alt":
        ms = data_util.load_accel_data('/home/luotianyi/eclipse_workspace_2/20220426_nips2022_project_real_dataset_code_with_rui/data/A_DeviceMotion_data/A_DeviceMotion_data/std_6/sub_19.csv')
        X, Y = ms, ms
        good_ts = None
        standardize_Y = False
